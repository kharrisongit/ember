...
def tint(image,flame=False):
 ...
 for r,g,b,a in out.get_flattened_data():
  ...
  elif (r,g,b)==(83,93,111):rgb=(round(light*.48+19),round(light*.52+20),round(light*.44+20))
...
for name,source,flame in [('torch','torch77_sn1',True),('door','dragon77_door',False),('bars','dragon77_bars',False),
 ...
 specs.append(dict(name='passage_'+name,w=a['w'],h=a['h'],frames=a['frames'],src='assets/interiors/mountain-passage/'+file+'?v=20260924-passage4'))
