...
def tint(image,flame=False):
 ...
 for r,g,b,a in out.getdata():
  ...
  else:rgb=(round(light*.9+18),round(light*.62+9),round(light*.88+13))
...
for name,source,flame in [('torch','torch77_sn1',True),('door','dragon77_door',False),('bars','dragon77_bars',False),
 ...
 specs.append(dict(name='passage_'+name,w=a['w'],h=a['h'],frames=a['frames'],src='assets/interiors/mountain-passage/'+file+'?v=20260924-passage1'))
