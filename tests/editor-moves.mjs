...
g.run(`features.push({id:9155,kind:'arena',x:168,y:67,r:6.3,style:'birch',encounter:'deer'},{id:9156,kind:'arena',x:220,y:90,r:6.3,style:'birch',encounter:'fox'});saveEditorDraft();`);
...
assert.equal(g.run('huntFresh.features.at(-1).encounter'),'fox','hunting type survives publication');
