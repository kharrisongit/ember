...
const c=vm.createContext({performance:{now:()=>clock},MAPID:'royal_treasury',W:{maps:{}},potions:0,elixirs:0,boarMeat:0,dragonFish:0,bombs:0,dust:0,bells:0,marks:0,breaths:0,stones:0,salts:0,treasuryTaken:new Set(),TREASURY_CHESTS:[{id:'test',x:100,y:100,n:600}],P:{x:100,y:120},treasuryGuarding:()=>false,gold:0,flyGold(){},showReveal(){assert.fail("Treasure should use a compact notice");},toast(){reveals++;},saveGame(){},SPR:{heartstone_chest:[0,0,asset.w,asset.h,asset.frames],temple71_chest:[0,0,32,32,6]},ctx:{},atlasImg:{},drawGameImage(g,img,sx,sy,sw){lastFrame=sx/sw;},TS:16,MD:{templeExpanded:true},breathHas:{},chestOpen:{},chestAnim:null,chestHere:()=>({map:'tp1_sanctum',x:5,y:5,gift:'lightning'})});
