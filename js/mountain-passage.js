window.EMBER_ASSETS.DOCK_ORIGINAL_ASSETS.push(...[{"name":"passage_torch","w":32,"h":48,"frames":6,"src":"assets/interiors/mountain-passage/passage-torch.png?v=20260924-passage4"},{"name":"passage_door","w":32,"h":48,"frames":4,"src":"assets/interiors/mountain-passage/passage-door.png?v=20260924-passage4"},{"name":"passage_bars","w":32,"h":48,"frames":4,"src":"assets/interiors/mountain-passage/passage-bars.png?v=20260924-passage4"},{"name":"passage_vent","w":16,"h":16,"frames":1,"src":"assets/interiors/mountain-passage/passage-vent.png?v=20260924-passage4"},{"name":"passage_flame_r","w":112,"h":32,"frames":9,"src":"assets/interiors/mountain-passage/passage-flame_r.png?v=20260924-passage4"},{"name":"passage_saw","w":32,"h":32,"frames":6,"src":"assets/interiors/mountain-passage/passage-saw.png?v=20260924-passage4"},{"name":"passage_rail","w":92,"h":3,"frames":1,"src":"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAFwAAAADCAYAAAAeN2h6AAAAJElEQVR4nGOMi4v7zzAK6AZYrl27NtBuGFGA5fv37wPthhEFAIMUB4rL4RDXAAAAAElFTkSuQmCC"}]);
...
async function prepareExpandedMountainPassage(){
  ...
  for(const [id,image] of images){
    ...
    const m=W.maps[id]={w:width/16,h:height/16,ts:16,title:'Mountain Passage',spawn:plan.spawn,
      ...
      bg:'#19171c',floorbg:'#3f443d',terr:terrRLE(Array(width*height/256).fill(DIRT)),
